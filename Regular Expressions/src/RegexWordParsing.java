...
public class RegexWordParsing {
	...
	public static void main(String[] args) {
		...
		System.out.println("1. Start of Word \\b\\w");
		...
		System.out.println("2. End of Word \\w\\b");
		...
		System.out.println("3. Words (Sans Hyphen) \\b\\w+\\b");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		// 00000_111_22222_33_444_555555__66___777_888888888_
//		System.out.println("4. Words (Sans Hyphen) \\w+");
//		RegexHelper.showMatches(RegexHelper.sample, "\\w+");
		...
		System.out.println("5. Words (With Hyphen) \\S+\\b");
		...
		System.out.println("6. Words (With Symbol) \\S+");
		...
		System.out.println("7. Words that start with S (?i)s\\S+\\b");
		...
		System.out.println("8. Words that contain an e \\b\\S*e\\S*\\b");
