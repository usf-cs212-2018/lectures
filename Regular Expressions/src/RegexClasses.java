...
public class RegexClasses {
	...
	public static void main(String[] args) {
		...
		//           0   1    2   3    4           5   6
		System.out.println("1. Lowercase s");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		// 0     1   2   3    4   5    6           7   8
		System.out.println("2. Lowercase or Uppercase [sS]");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		// 0     1   2   3    4   5    6           7   8
		System.out.println("3. Lowercase or Uppercase (?i)s");
		...
		System.out.println("4. Lowercase Letters [a-z]");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		// 0     1
		System.out.println("5. Uppercase  Letters \\p{Upper}");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		//                 01
		System.out.println("6. Digit Characters \\d");
		...
		System.out.println("7. Word Characters \\w");
		...
		System.out.println("8. Non-Whitespace Characters \\S");
		RegexHelper.showMatches(RegexHelper.sample, "\\S");
		...
		// Sally Sue sells 76 sea-shells, by   the sea_shore.
		//      0   1     2  3           4  567   8
		System.out.println("9. Whitespaces \\s");
		RegexHelper.showMatches(RegexHelper.sample, "\\s");
		...
		System.out.println("10. Non-Word Characters \\W");
		RegexHelper.showMatches(RegexHelper.sample, "\\W");
		...
		System.out.println("11. Any Character .");
